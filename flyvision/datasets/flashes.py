...
@root(root_dir)
class MultiParameterFlash(Directory):
    class Config:
        boxfilter: dict
    ...
    def __init__(self, config: Config):
        boxfilter = BoxEye(config.boxfilter.extent, config.boxfilter.kernel_size)
...
class Flashes(SequenceDataset):
    ...
    def __init__(
        ...
        self.flashes_dir = MultiParameterFlash(
            boxfilter=boxfilter,
