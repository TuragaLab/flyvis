# Pipeline Manager Help

Script: `scripts/scripts/pipeline_manager.py`

```
usage: pipeline_manager.py [-h] --ensemble_id ENSEMBLE_ID --task_name
                           TASK_NAME --command
                           {train,validate,record,analysis,notebook_per_model,notebook}
                           [{train,validate,record,analysis,notebook_per_model,notebook} ...]
...
optional arguments:
  ...
  --command {train,validate,record,analysis,notebook_per_model,notebook} [{train,validate,record,analysis,notebook_per_model,notebook} ...]
